...
Page({
  ...
  loadmovies() {
    ...
    request({
      ...
      const promotionListData = this.data.promotionListData;
      console.log(promotionListData);
      console.log(data);
      promotionListData.push(...data);
      console.log(promotionListData);
      this.setData({
        promotionListData: promotionListData
      })
  ...
  onLoad: function(options) {
    ...
    request({
      ...
      firstCaregory.unshift({id:"",name:'全部分类'});
      secondCaregory.unshift([{ id: "", name: '全部分类' }]);
